...
async def _build_travel(state: UnifiedAgentState) -> UnifiedAgentState:
...
def build_unified_graph():
    ...
    graph.add_conditional_edges('build_travel', _after_travel_reflect, {'repair_travel': 'repair_travel', 'end': END})
